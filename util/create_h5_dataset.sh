...
sudo docker exec -it baikal_gen_auto /bin/bash -c 'cd packages/framework; echo "/gps/pos/centre 0 0 600 m" >> current_config.mac'
sudo docker exec -it baikal_gen_auto /bin/bash -c 'cd packages/framework; echo "/gps/pos/radius 2000 m" >> current_config.mac'
sudo docker exec -it baikal_gen_auto /bin/bash -c 'cd packages/framework; echo "/gps/pos/halfz 500 m" >> current_config.mac'
